                        ...
                        <div class="col-md-12">
                            <nav aria-label="Page navigation">
                                <ul class="pagination justify-content-start">
                                    <li class="page-item"><a class="page-link" href='<c:url value="/trang-chu?page=${1}"/>'>1</a></li>
                                    <li class="page-item"><a class="page-link" href='<c:url value="/trang-chu?page=${2}"/>'>2</a></li>
                                    <li class="page-item"><a class="page-link" href='<c:url value="/trang-chu?page=${3}"/>'>3</a></li>
                                    <li class="page-item">
